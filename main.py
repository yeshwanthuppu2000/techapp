...
def dashboard_stats():
    ...
    # In a real app, you'd query your documents table
    document_stats = {
        'docx': 120,
        'xlsx': 80,
        'csv': 150,
    ...
    return jsonify({
        'kpis': {
            ...
            'documents_processed': sum(document_stats.values())
        },
        'user_role_chart': {
            'labels': ['Admins', 'Users'],
        ...
        'doc_types_chart': {
            'labels': list(document_stats.keys()),
            'data': list(document_stats.values())
        }
    })
